...
export default function Cart() {
  ...
  const handleAddDummyMenu = () => {
    const dummyMenu = {
      menuId: Math.floor(Math.random() * 10000),
      menuName: "테스트 메뉴",
      menuPrice: 3000,
      menuOption: [],
      menuTotalPrice: 3000,
  ...
  return (
    <div className={styles.container}>
            ...
            <div className={styles.quantity}>
              <QuantityControl
                ...
                onQuantityChange={(delta) =>
                  handleQuantityChange(menu.menuId, JSON.stringify(menu.menuOption), delta)
                }
              />
      ...
      <BottomButton onClick={handlePayment} disabled={orderMenus.length === 0} cartInfo={cartInfo} />
