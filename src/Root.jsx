...
const PaymentSuccess = React.lazy(() => import("./pages/payments/PaymentSuccess").then(module => ({ default: module.PaymentSuccess })));
const PaymentFailure = React.lazy(() => import("./pages/payments/PaymentFailure").then(module => ({ default: module.PaymentFailure })));
const TossPaymentSuccess = React.lazy(() => import("./pages/payments/TossPaymentSuccess").then(module => ({ default: module.TossPaymentSuccess })));
